...
export const matches: Match[] = [
  ...
  {
    id: 39, date: '2026-06-21', time: '18:00 ET', group: 'H', home: 'URU', away: 'CPV', venue: 'Hard Rock Stadium', city: 'Miami', status: 'finished', homeScore: 2, awayScore: 2,
    events: [
      { minute: "5'", type: 'yellow', side: 'away', player: 'Sidny Lopes Cabral' },
      { minute: "20'", type: 'yellow', side: 'home', player: 'Rodrigo Bentancur' },
      { minute: "21'", type: 'goal', side: 'away', player: 'Kevin Pina' },
      { minute: "44'", type: 'goal', side: 'home', player: 'Maxi Araújo' },
      { minute: "45+6'", type: 'goal', side: 'home', player: 'Agustín Canobbio' },
      { minute: "58'", type: 'yellow', side: 'home', player: 'Mathías Olivera' },
      { minute: "61'", type: 'goal', side: 'away', player: 'Hélio Varela' },
      { minute: "90+3'", type: 'yellow', side: 'away', player: 'Diney Borges' },
    ],
    stats: [
      { label: 'Ball possession', home: 65, away: 35, unit: '%' },
      { label: 'Expected goals (xG)', home: 2.32, away: 0.89 },
      { label: 'Total shots', home: 17, away: 12 },
      { label: 'Shots on target', home: 2, away: 4 },
      { label: 'Saves', home: 2, away: 0 },
      { label: 'Fouls', home: 11, away: 4 },
      { label: 'Yellow cards', home: 2, away: 2 },
    ],
  },
  {
    id: 40, date: '2026-06-21', time: '18:00 PT', group: 'G', home: 'NZL', away: 'EGY', venue: 'BC Place', city: 'Vancouver', status: 'finished', homeScore: 1, awayScore: 3,
    events: [
      { minute: "15'", type: 'goal', side: 'home', player: 'Finn Surman' },
      { minute: "17'", type: 'yellow', side: 'away', player: 'Mohanad Lashin' },
      { minute: "20'", type: 'yellow', side: 'home', player: 'Sarpreet Singh' },
      { minute: "34'", type: 'yellow', side: 'home', player: 'Callum McCowatt' },
      { minute: "58'", type: 'goal', side: 'away', player: 'Mostafa Zico' },
      { minute: "67'", type: 'goal', side: 'away', player: 'Mohamed Salah' },
      { minute: "82'", type: 'goal', side: 'away', player: 'Trézéguet' },
    ],
    stats: [
      { label: 'Ball possession', home: 44, away: 56, unit: '%' },
      { label: 'Expected goals (xG)', home: 1.24, away: 1.87 },
      { label: 'Total shots', home: 8, away: 10 },
      { label: 'Shots on target', home: 5, away: 7 },
      { label: 'Saves', home: 4, away: 4 },
      { label: 'Fouls', home: 14, away: 8 },
      { label: 'Yellow cards', home: 2, away: 1 },
    ],
  },
  // Monday, June 22
  {
    id: 41, date: '2026-06-22', time: '12:00 CDT', group: 'J', home: 'ARG', away: 'AUT', venue: 'AT&T Stadium', city: 'Dallas', status: 'finished', homeScore: 2, awayScore: 0,
    events: [
      { minute: "38'", type: 'goal', side: 'home', player: 'Lionel Messi' },
      { minute: "40'", type: 'yellow', side: 'away', player: 'Stefan Posch' },
      { minute: "76'", type: 'yellow', side: 'home', player: 'Facundo Medina' },
      { minute: "76'", type: 'yellow', side: 'away', player: 'Konrad Laimer' },
      { minute: "90+2'", type: 'yellow', side: 'home', player: 'Leandro Paredes' },
      { minute: "90+5'", type: 'goal', side: 'home', player: 'Lionel Messi' },
    ],
    stats: [
      { label: 'Ball possession', home: 54, away: 46, unit: '%' },
      { label: 'Expected goals (xG)', home: 2.36, away: 0.53 },
      { label: 'Total shots', home: 12, away: 6 },
      { label: 'Shots on target', home: 5, away: 1 },
      { label: 'Saves', home: 1, away: 2 },
      { label: 'Fouls', home: 13, away: 13 },
      { label: 'Yellow cards', home: 2, away: 2 },
    ],
  },
  {
    id: 42, date: '2026-06-22', time: '17:00 ET', group: 'I', home: 'FRA', away: 'IRQ', venue: 'Lincoln Financial Field', city: 'Philadelphia', status: 'finished', homeScore: 3, awayScore: 0,
    events: [
      { minute: "6'", type: 'yellow', side: 'away', player: 'Amir Al-Ammari' },
      { minute: "14'", type: 'goal', side: 'home', player: 'Kylian Mbappé' },
      { minute: "54'", type: 'goal', side: 'home', player: 'Kylian Mbappé' },
      { minute: "66'", type: 'goal', side: 'home', player: 'Ousmane Dembélé' },
    ],
    stats: [
      { label: 'Ball possession', home: 56, away: 44, unit: '%' },
      { label: 'Expected goals (xG)', home: 2.67, away: 0.63 },
      { label: 'Total shots', home: 19, away: 4 },
      { label: 'Shots on target', home: 5, away: 0 },
      { label: 'Saves', home: 0, away: 2 },
      { label: 'Fouls', home: 8, away: 4 },
      { label: 'Yellow cards', home: 0, away: 1 },
    ],
  },
  {
    id: 43, date: '2026-06-22', time: '20:00 ET', group: 'I', home: 'NOR', away: 'SEN', venue: 'MetLife Stadium', city: 'New York / New Jersey', status: 'finished', homeScore: 3, awayScore: 2,
    events: [
      { minute: "43'", type: 'goal', side: 'home', player: 'Marcus Holmgren Pedersen' },
      { minute: "48'", type: 'goal', side: 'home', player: 'Erling Haaland' },
      { minute: "53'", type: 'goal', side: 'away', player: 'Ismaïla Sarr' },
      { minute: "58'", type: 'goal', side: 'home', player: 'Erling Haaland' },
      { minute: "90+3'", type: 'goal', side: 'away', player: 'Ismaïla Sarr' },
    ],
    stats: [
      { label: 'Ball possession', home: 42, away: 58, unit: '%' },
      { label: 'Expected goals (xG)', home: 2.20, away: 1.72 },
      { label: 'Total shots', home: 13, away: 16 },
      { label: 'Shots on target', home: 7, away: 4 },
      { label: 'Saves', home: 2, away: 3 },
      { label: 'Fouls', home: 13, away: 5 },
    ],
  },
  {
    id: 44, date: '2026-06-22', time: '20:00 PT', group: 'J', home: 'JOR', away: 'ALG', venue: "Levi's Stadium", city: 'San Francisco Bay Area', status: 'finished', homeScore: 1, awayScore: 2,
    events: [
      { minute: "36'", type: 'goal', side: 'home', player: 'Nizar Al-Rashdan' },
      { minute: "44'", type: 'yellow', side: 'away', player: 'Ramiz Zerrouki' },
      { minute: "64'", type: 'yellow', side: 'home', player: 'Husam Abu Dahab' },
      { minute: "69'", type: 'goal', side: 'away', player: 'Nadhir Benbouali' },
      { minute: "82'", type: 'goal', side: 'away', player: 'Amine Gouiri' },
    ],
    stats: [
      { label: 'Ball possession', home: 28, away: 72, unit: '%' },
      { label: 'Expected goals (xG)', home: 0.64, away: 1.89 },
      { label: 'Total shots', home: 8, away: 17 },
      { label: 'Shots on target', home: 4, away: 8 },
      { label: 'Saves', home: 6, away: 3 },
      { label: 'Fouls', home: 11, away: 6 },
      { label: 'Yellow cards', home: 1, away: 1 },
    ],
  },
  // Tuesday, June 23
  {
    id: 45, date: '2026-06-23', time: '12:00 CDT', group: 'K', home: 'POR', away: 'UZB', venue: 'NRG Stadium', city: 'Houston', status: 'finished', homeScore: 5, awayScore: 0,
    events: [
      { minute: "6'", type: 'goal', side: 'home', player: 'Cristiano Ronaldo' },
      { minute: "14'", type: 'yellow', side: 'away', player: 'Odiljon Xamrobekov' },
      { minute: "17'", type: 'goal', side: 'home', player: 'Nuno Mendes' },
      { minute: "39'", type: 'goal', side: 'home', player: 'Cristiano Ronaldo' },
      { minute: "60'", type: 'goal', side: 'home', player: 'Abduvohid Nematov', note: 'own goal' },
      { minute: "68'", type: 'yellow', side: 'home', player: 'Renato Veiga' },
      { minute: "87'", type: 'goal', side: 'home', player: 'Rafael Leão' },
    ],
    stats: [
      { label: 'Ball possession', home: 66, away: 34, unit: '%' },
      { label: 'Expected goals (xG)', home: 2.61, away: 0.24 },
      { label: 'Total shots', home: 17, away: 7 },
  ...
  {
    id: 46, date: '2026-06-23', time: '16:00 ET', group: 'L', home: 'ENG', away: 'GHA', venue: 'Gillette Stadium', city: 'Boston', status: 'finished', homeScore: 0, awayScore: 0,
    events: [
      { minute: "41'", type: 'yellow', side: 'home', player: 'Declan Rice' },
      { minute: "60'", type: 'yellow', side: 'away', player: 'Iñaki Williams' },
    ],
    stats: [
      { label: 'Ball possession', home: 79, away: 21, unit: '%' },
      { label: 'Expected goals (xG)', home: 1.28, away: 0.29 },
      { label: 'Total shots', home: 19, away: 2 },
      { label: 'Shots on target', home: 3, away: 1 },
      { label: 'Saves', home: 0, away: 3 },
      { label: 'Fouls', home: 14, away: 24 },
      { label: 'Yellow cards', home: 1, away: 1 },
    ],
  },
  {
    id: 47, date: '2026-06-23', time: '19:00 ET', group: 'L', home: 'PAN', away: 'CRO', venue: 'BMO Field', city: 'Toronto', status: 'finished', homeScore: 0, awayScore: 1,
    events: [
      { minute: "54'", type: 'goal', side: 'away', player: 'Ante Budimir' },
      { minute: "61'", type: 'yellow', side: 'home', player: 'Edgar Yoel Bárcenas' },
      { minute: "90+2'", type: 'yellow', side: 'away', player: 'Petar Sučić' },
    ],
    stats: [
      { label: 'Ball possession', home: 42, away: 58, unit: '%' },
      { label: 'Expected goals (xG)', home: 0.55, away: 1.65 },
      { label: 'Total shots', home: 8, away: 6 },
      { label: 'Shots on target', home: 1, away: 2 },
      { label: 'Saves', home: 1, away: 1 },
      { label: 'Fouls', home: 19, away: 12 },
      { label: 'Yellow cards', home: 1, away: 1 },
    ],
  },
  {
    id: 48, date: '2026-06-23', time: '20:00 CST', group: 'K', home: 'COL', away: 'COD', venue: 'Estadio Akron', city: 'Guadalajara', status: 'finished', homeScore: 1, awayScore: 0,
    events: [
      { minute: "56'", type: 'yellow', side: 'home', player: 'Jhon Lucumí' },
      { minute: "76'", type: 'goal', side: 'home', player: 'Daniel Muñoz' },
      { minute: "90+3'", type: 'yellow', side: 'away', player: 'Charles Pickel' },
      { minute: "90+4'", type: 'yellow', side: 'home', player: 'Jefferson Lerma' },
    ],
    stats: [
      { label: 'Ball possession', home: 64, away: 36, unit: '%' },
      { label: 'Expected goals (xG)', home: 0.98, away: 0.37 },
      { label: 'Total shots', home: 20, away: 7 },
      { label: 'Shots on target', home: 9, away: 1 },
      { label: 'Saves', home: 1, away: 8 },
      { label: 'Fouls', home: 12, away: 16 },
      { label: 'Yellow cards', home: 2, away: 1 },
    ],
  },
  // Wednesday, June 24
  {
    id: 49, date: '2026-06-24', time: '12:00 PT', group: 'B', home: 'SUI', away: 'CAN', venue: 'BC Place', city: 'Vancouver', status: 'finished', homeScore: 2, awayScore: 1,
    events: [
      { minute: "32'", type: 'yellow', side: 'home', player: 'Granit Xhaka' },
      { minute: "32'", type: 'yellow', side: 'away', player: 'Cyle Larin' },
      { minute: "46'", type: 'goal', side: 'home', player: 'Rubén Vargas' },
      { minute: "57'", type: 'goal', side: 'home', player: 'Johan Manzambi' },
      { minute: "76'", type: 'goal', side: 'away', player: 'Promise David' },
      { minute: "87'", type: 'yellow', side: 'away', player: 'Liam Millar' },
    ],
    stats: [
      { label: 'Ball possession', home: 55, away: 45, unit: '%' },
      { label: 'Expected goals (xG)', home: 1.11, away: 1.66 },
      { label: 'Total shots', home: 6, away: 13 },
      { label: 'Shots on target', home: 4, away: 7 },
      { label: 'Saves', home: 6, away: 2 },
      { label: 'Fouls', home: 19, away: 13 },
      { label: 'Yellow cards', home: 1, away: 2 },
    ],
  },
  {
    id: 50, date: '2026-06-24', time: '12:00 PT', group: 'B', home: 'BIH', away: 'QAT', venue: 'Lumen Field', city: 'Seattle', status: 'finished', homeScore: 3, awayScore: 1,
    events: [
      { minute: "29'", type: 'goal', side: 'home', player: 'Kerim Alajbegović' },
      { minute: "34'", type: 'goal', side: 'home', player: 'Mahmoud Abunada', note: 'own goal' },
      { minute: "42'", type: 'goal', side: 'away', player: 'Hassan Al-Haydos' },
      { minute: "78'", type: 'yellow', side: 'away', player: 'Ahmed Fathy' },
      { minute: "80'", type: 'goal', side: 'home', player: 'Ermin Mahmić' },
      { minute: "82'", type: 'yellow', side: 'home', player: 'Ermin Mahmić' },
    ],
    stats: [
      { label: 'Ball possession', home: 54, away: 46, unit: '%' },
      { label: 'Expected goals (xG)', home: 0.68, away: 0.77 },
  ...
  {
    id: 51, date: '2026-06-24', time: '18:00 ET', group: 'C', home: 'SCO', away: 'BRA', venue: 'Hard Rock Stadium', city: 'Miami', status: 'finished', homeScore: 0, awayScore: 3,
    events: [
      { minute: "7'", type: 'goal', side: 'away', player: 'Vinícius Júnior' },
      { minute: "45+3'", type: 'goal', side: 'away', player: 'Vinícius Júnior' },
      { minute: "60'", type: 'goal', side: 'away', player: 'Matheus Cunha' },
      { minute: "62'", type: 'yellow', side: 'away', player: 'Danilo' },
      { minute: "82'", type: 'yellow', side: 'away', player: 'Fabinho' },
      { minute: "89'", type: 'yellow', side: 'home', player: 'Ryan Christie' },
    ],
    stats: [
      { label: 'Ball possession', home: 46, away: 54, unit: '%' },
      { label: 'Expected goals (xG)', home: 1.04, away: 4.33 },
      { label: 'Total shots', home: 14, away: 21 },
      { label: 'Shots on target', home: 5, away: 9 },
      { label: 'Saves', home: 5, away: 5 },
      { label: 'Fouls', home: 10, away: 11 },
      { label: 'Yellow cards', home: 1, away: 2 },
    ],
  },
  {
    id: 52, date: '2026-06-24', time: '18:00 ET', group: 'C', home: 'MAR', away: 'HAI', venue: 'Mercedes-Benz Stadium', city: 'Atlanta', status: 'finished', homeScore: 4, awayScore: 2,
    events: [
      { minute: "10'", type: 'goal', side: 'away', player: 'Yassine Bounou', note: 'own goal' },
      { minute: "39'", type: 'goal', side: 'home', player: 'Achraf Hakimi' },
      { minute: "43'", type: 'goal', side: 'away', player: 'Wilson Isidor' },
      { minute: "45+1'", type: 'goal', side: 'home', player: 'Ismael Saibari' },
      { minute: "78'", type: 'goal', side: 'home', player: 'Soufiane Rahimi' },
      { minute: "79'", type: 'yellow', side: 'away', player: 'Johny Placide' },
      { minute: "79'", type: 'yellow', side: 'away', player: 'Duckens Nazon' },
      { minute: "89'", type: 'goal', side: 'home', player: 'Gessime Yassine' },
      { minute: "90+3'", type: 'yellow', side: 'away', player: 'Josué Casimir' },
    ],
    stats: [
      { label: 'Ball possession', home: 69, away: 31, unit: '%' },
      { label: 'Expected goals (xG)', home: 3.76, away: 0.67 },
      { label: 'Total shots', home: 22, away: 9 },
      { label: 'Shots on target', home: 11, away: 2 },
      { label: 'Saves', home: 1, away: 8 },
      { label: 'Fouls', home: 10, away: 18 },
      { label: 'Yellow cards', home: 0, away: 3 },
    ],
  },
  {
    id: 53, date: '2026-06-24', time: '19:00 CST', group: 'A', home: 'CZE', away: 'MEX', venue: 'Estadio Azteca', city: 'Mexico City', status: 'finished', homeScore: 0, awayScore: 3,
    events: [
      { minute: "55'", type: 'goal', side: 'away', player: 'Mateo Chávez' },
      { minute: "61'", type: 'goal', side: 'away', player: 'Julián Quiñones' },
      { minute: "63'", type: 'yellow', side: 'away', player: 'Edson Álvarez' },
      { minute: "90+4'", type: 'goal', side: 'away', player: 'Álvaro Fidalgo' },
    ],
    stats: [
      { label: 'Ball possession', home: 52, away: 48, unit: '%' },
      { label: 'Expected goals (xG)', home: 0.53, away: 1.74 },
      { label: 'Total shots', home: 13, away: 11 },
      { label: 'Shots on target', home: 1, away: 5 },
      { label: 'Saves', home: 2, away: 1 },
  ...
  {
    id: 54, date: '2026-06-24', time: '19:00 CST', group: 'A', home: 'RSA', away: 'KOR', venue: 'Estadio BBVA', city: 'Monterrey', status: 'finished', homeScore: 1, awayScore: 0,
    events: [
      { minute: "63'", type: 'goal', side: 'home', player: 'Thapelo Maseko' },
      { minute: "72'", type: 'yellow', side: 'home', player: 'Aubrey Modiba' },
      { minute: "78'", type: 'yellow', side: 'away', player: 'Cho Gue-sung' },
    ],
    stats: [
      { label: 'Ball possession', home: 32, away: 68, unit: '%' },
      { label: 'Expected goals (xG)', home: 1.16, away: 0.90 },
  ...
  // Thursday, June 25
  {
    id: 55, date: '2026-06-25', time: '16:00 ET', group: 'E', home: 'ECU', away: 'GER', venue: 'MetLife Stadium', city: 'New York / New Jersey', status: 'finished', homeScore: 2, awayScore: 1,
    events: [
      { minute: "2'", type: 'goal', side: 'away', player: 'Leroy Sané' },
      { minute: "9'", type: 'goal', side: 'home', player: 'Nilson Angulo' },
      { minute: "43'", type: 'yellow', side: 'home', player: 'Piero Hincapié' },
      { minute: "44'", type: 'yellow', side: 'away', player: 'Aleksandar Pavlović' },
      { minute: "50'", type: 'yellow', side: 'home', player: 'Alan Franco' },
      { minute: "77'", type: 'goal', side: 'home', player: 'Gonzalo Plata' },
      { minute: "89'", type: 'yellow', side: 'home', player: 'Gonzalo Plata' },
    ],
    stats: [
      { label: 'Ball possession', home: 39, away: 61, unit: '%' },
      { label: 'Expected goals (xG)', home: 1.27, away: 0.65 },
      { label: 'Total shots', home: 7, away: 11 },
      { label: 'Shots on target', home: 3, away: 3 },
      { label: 'Saves', home: 2, away: 1 },
      { label: 'Fouls', home: 15, away: 10 },
      { label: 'Yellow cards', home: 3, away: 1 },
    ],
  },
  {
    id: 56, date: '2026-06-25', time: '16:00 ET', group: 'E', home: 'CUW', away: 'CIV', venue: 'Lincoln Financial Field', city: 'Philadelphia', status: 'finished', homeScore: 0, awayScore: 2,
    events: [
      { minute: "7'", type: 'goal', side: 'away', player: 'Nicolas Pépé' },
      { minute: "34'", type: 'yellow', side: 'away', player: 'Nicolas Pépé' },
      { minute: "64'", type: 'goal', side: 'away', player: 'Nicolas Pépé' },
      { minute: "75'", type: 'yellow', side: 'home', player: 'Juninho Bacuna' },
      { minute: "83'", type: 'yellow', side: 'home', player: 'Gervane Kastaneer' },
    ],
    stats: [
      { label: 'Ball possession', home: 37, away: 63, unit: '%' },
      { label: 'Expected goals (xG)', home: 0.50, away: 1.31 },
  ...
  {
    id: 57, date: '2026-06-25', time: '18:00 CDT', group: 'F', home: 'JPN', away: 'SWE', venue: 'AT&T Stadium', city: 'Dallas', status: 'finished', homeScore: 1, awayScore: 1,
    events: [
      { minute: "32'", type: 'yellow', side: 'away', player: 'Isak Hien' },
      { minute: "56'", type: 'goal', side: 'home', player: 'Daizen Maeda' },
      { minute: "62'", type: 'goal', side: 'away', player: 'Anthony Elanga' },
      { minute: "77'", type: 'yellow', side: 'home', player: 'Shogo Taniguchi' },
      { minute: "84'", type: 'yellow', side: 'away', player: 'Viktor Gyökeres' },
    ],
    stats: [
      { label: 'Ball possession', home: 52, away: 48, unit: '%' },
      { label: 'Expected goals (xG)', home: 1.21, away: 0.64 },
      { label: 'Total shots', home: 8, away: 11 },
      { label: 'Shots on target', home: 3, away: 5 },
      { label: 'Saves', home: 4, away: 2 },
      { label: 'Fouls', home: 20, away: 11 },
      { label: 'Yellow cards', home: 1, away: 2 },
    ],
  },
  {
    id: 58, date: '2026-06-25', time: '18:00 CDT', group: 'F', home: 'TUN', away: 'NED', venue: 'Arrowhead Stadium', city: 'Kansas City', status: 'finished', homeScore: 1, awayScore: 3,
    events: [
      { minute: "3'", type: 'goal', side: 'away', player: 'Ellyes Skhiri', note: 'own goal' },
      { minute: "7'", type: 'goal', side: 'away', player: 'Brian Brobbey' },
      { minute: "54'", type: 'goal', side: 'home', player: 'Hazem Mastouri' },
      { minute: "62'", type: 'goal', side: 'away', player: 'Jan Paul van Hecke' },
    ],
    stats: [
      { label: 'Ball possession', home: 29, away: 71, unit: '%' },
      { label: 'Expected goals (xG)', home: 0.62, away: 1.84 },
      { label: 'Total shots', home: 10, away: 20 },
      { label: 'Shots on target', home: 4, away: 7 },
      { label: 'Saves', home: 4, away: 3 },
      { label: 'Fouls', home: 11, away: 10 },
    ],
  },
  {
    id: 59, date: '2026-06-25', time: '19:00 PT', group: 'D', home: 'TUR', away: 'USA', venue: 'SoFi Stadium', city: 'Los Angeles', status: 'finished', homeScore: 3, awayScore: 2,
    events: [
      { minute: "3'", type: 'goal', side: 'away', player: 'Auston Trusty' },
      { minute: "10'", type: 'goal', side: 'home', player: 'Arda Güler' },
      { minute: "19'", type: 'yellow', side: 'away', player: 'Sebastian Berhalter' },
      { minute: "31'", type: 'goal', side: 'home', player: 'Barış Alper Yılmaz' },
      { minute: "49'", type: 'goal', side: 'away', player: 'Sebastian Berhalter' },
      { minute: "90+8'", type: 'goal', side: 'home', player: 'Kaan Ayhan' },
    ],
    stats: [
      { label: 'Ball possession', home: 47, away: 53, unit: '%' },
      { label: 'Expected goals (xG)', home: 3.01, away: 2.13 },
      { label: 'Total shots', home: 9, away: 18 },
      { label: 'Shots on target', home: 3, away: 7 },
      { label: 'Saves', home: 5, away: 1 },
      { label: 'Fouls', home: 13, away: 13 },
      { label: 'Yellow cards', home: 0, away: 1 },
    ],
  },
  {
    id: 60, date: '2026-06-25', time: '19:00 PT', group: 'D', home: 'PAR', away: 'AUS', venue: "Levi's Stadium", city: 'San Francisco Bay Area', status: 'finished', homeScore: 0, awayScore: 0,
    events: [
      { minute: "46'", type: 'yellow', side: 'away', player: 'Jackson Irvine' },
      { minute: "77'", type: 'yellow', side: 'home', player: 'Diego Gómez' },
    ],
    stats: [
      { label: 'Ball possession', home: 44, away: 56, unit: '%' },
      { label: 'Expected goals (xG)', home: 0.24, away: 0.55 },
      { label: 'Total shots', home: 7, away: 12 },
      { label: 'Shots on target', home: 2, away: 5 },
      { label: 'Saves', home: 5, away: 2 },
      { label: 'Fouls', home: 9, away: 6 },
      { label: 'Yellow cards', home: 1, away: 1 },
    ],
  },
  // Friday, June 26
  {
    id: 61, date: '2026-06-26', time: '15:00 ET', group: 'I', home: 'NOR', away: 'FRA', venue: 'Gillette Stadium', city: 'Boston', status: 'finished', homeScore: 1, awayScore: 4,
    events: [
      { minute: "7'", type: 'goal', side: 'away', player: 'Ousmane Dembélé' },
      { minute: "10'", type: 'yellow', side: 'home', player: 'Patrick Berg' },
      { minute: "20'", type: 'goal', side: 'away', player: 'Ousmane Dembélé' },
      { minute: "21'", type: 'goal', side: 'home', player: 'Thelo Aasgaard' },
      { minute: "32'", type: 'goal', side: 'away', player: 'Ousmane Dembélé' },
      { minute: "74'", type: 'yellow', side: 'away', player: 'Aurélien Tchouaméni' },
      { minute: "90+4'", type: 'goal', side: 'away', player: 'Désiré Doué' },
    ],
    stats: [
      { label: 'Ball possession', home: 43, away: 57, unit: '%' },
      { label: 'Expected goals (xG)', home: 1.70, away: 1.50 },
      { label: 'Total shots', home: 10, away: 18 },
      { label: 'Shots on target', home: 4, away: 9 },
      { label: 'Saves', home: 5, away: 3 },
      { label: 'Fouls', home: 9, away: 11 },
      { label: 'Yellow cards', home: 1, away: 1 },
    ],
  ...
  {
    id: 62, date: '2026-06-26', time: '15:00 ET', group: 'I', home: 'SEN', away: 'IRQ', venue: 'BMO Field', city: 'Toronto', status: 'finished', homeScore: 5, awayScore: 0,
    events: [
      { minute: "4'", type: 'goal', side: 'home', player: 'Habib Diarra' },
      { minute: "13'", type: 'red', side: 'away', player: 'Rebin Sulaka' },
      { minute: "18'", type: 'yellow', side: 'home', player: 'Abdoulaye Seck' },
      { minute: "56'", type: 'goal', side: 'home', player: 'Ismaïla Sarr' },
      { minute: "59'", type: 'goal', side: 'home', player: 'Pape Gueye' },
      { minute: "71'", type: 'goal', side: 'home', player: 'Pape Gueye' },
      { minute: "82'", type: 'goal', side: 'home', player: 'Iliman Ndiaye' },
    ],
    stats: [
      { label: 'Ball possession', home: 69, away: 31, unit: '%' },
      { label: 'Expected goals (xG)', home: 3.01, away: 0.14 },
      { label: 'Total shots', home: 28, away: 6 },
      { label: 'Shots on target', home: 12, away: 1 },
      { label: 'Saves', home: 1, away: 7 },
      { label: 'Fouls', home: 10, away: 11 },
      { label: 'Yellow cards', home: 2, away: 2 },
      { label: 'Red cards', home: 0, away: 1 },
  ...
  {
    id: 63, date: '2026-06-26', time: '19:00 CDT', group: 'H', home: 'CPV', away: 'KSA', venue: 'NRG Stadium', city: 'Houston', status: 'finished', homeScore: 0, awayScore: 0,
    events: [
      { minute: "4'", type: 'yellow', side: 'away', player: 'Saud Abdulhamid' },
      { minute: "8'", type: 'yellow', side: 'home', player: 'Wagner Pina' },
      { minute: "67'", type: 'yellow', side: 'away', player: 'Nasser Al-Dawsari' },
      { minute: "90+3'", type: 'yellow', side: 'away', player: 'Feras Al-Brikan' },
    ],
    stats: [
      { label: 'Ball possession', home: 51, away: 49, unit: '%' },
      { label: 'Expected goals (xG)', home: 1.39, away: 0.39 },
      { label: 'Total shots', home: 15, away: 7 },
      { label: 'Shots on target', home: 2, away: 3 },
      { label: 'Saves', home: 3, away: 2 },
  ...
  {
    id: 64, date: '2026-06-26', time: '18:00 CST', group: 'H', home: 'URU', away: 'ESP', venue: 'Estadio Akron', city: 'Guadalajara', status: 'finished', homeScore: 0, awayScore: 1,
    events: [
      { minute: "42'", type: 'goal', side: 'away', player: 'Álex Baena' },
      { minute: "46'", type: 'yellow', side: 'away', player: 'Álex Baena' },
      { minute: "54'", type: 'yellow', side: 'home', player: 'Juan Manuel Sanabria' },
      { minute: "58'", type: 'yellow', side: 'home', player: 'Guillermo Varela' },
      { minute: "90+3'", type: 'yellow', side: 'home', player: 'Nicolás de la Cruz' },
      { minute: "90+4'", type: 'red', side: 'home', player: 'Agustín Canobbio' },
    ],
    stats: [
      { label: 'Ball possession', home: 33, away: 67, unit: '%' },
      { label: 'Expected goals (xG)', home: 0.20, away: 0.86 },
      { label: 'Total shots', home: 5, away: 6 },
      { label: 'Shots on target', home: 1, away: 1 },
      { label: 'Saves', home: 0, away: 2 },
      { label: 'Fouls', home: 14, away: 14 },
      { label: 'Yellow cards', home: 3, away: 1 },
      { label: 'Red cards', home: 1, away: 0 },
    ],
  },
  {
    id: 65, date: '2026-06-26', time: '20:00 PT', group: 'G', home: 'EGY', away: 'IRN', venue: 'Lumen Field', city: 'Seattle', status: 'finished', homeScore: 1, awayScore: 1,
    events: [
      { minute: "5'", type: 'goal', side: 'home', player: 'Mahmoud Saber' },
      { minute: "14'", type: 'goal', side: 'away', player: 'Ramin Rezaeian' },
      { minute: "18'", type: 'yellow', side: 'home', player: 'Mahmoud Saber' },
      { minute: "18'", type: 'yellow', side: 'away', player: 'Hossein Kanani' },
      { minute: "41'", type: 'yellow', side: 'home', player: 'Yasser Ibrahim' },
      { minute: "43'", type: 'yellow', side: 'away', player: 'Ali Nemati' },
      { minute: "79'", type: 'yellow', side: 'away', player: 'Saeid Ezatolahi' },
      { minute: "90+2'", type: 'yellow', side: 'home', player: 'Mohanad Lashin' },
    ],
    stats: [
      { label: 'Ball possession', home: 61, away: 39, unit: '%' },
      { label: 'Expected goals (xG)', home: 0.81, away: 1.96 },
      { label: 'Total shots', home: 15, away: 13 },
      { label: 'Shots on target', home: 3, away: 4 },
      { label: 'Saves', home: 2, away: 2 },
  ...
  {
    id: 66, date: '2026-06-26', time: '20:00 PT', group: 'G', home: 'NZL', away: 'BEL', venue: 'BC Place', city: 'Vancouver', status: 'finished', homeScore: 1, awayScore: 5,
    events: [
      { minute: "28'", type: 'goal', side: 'away', player: 'Leandro Trossard' },
      { minute: "46'", type: 'yellow', side: 'home', player: 'Marko Stamenić' },
      { minute: "50'", type: 'goal', side: 'away', player: 'Leandro Trossard' },
      { minute: "56'", type: 'yellow', side: 'home', player: 'Elijah Just' },
      { minute: "66'", type: 'goal', side: 'away', player: 'Kevin De Bruyne' },
      { minute: "84'", type: 'goal', side: 'home', player: 'Elijah Just' },
      { minute: "86'", type: 'goal', side: 'away', player: 'Romelu Lukaku' },
      { minute: "90+4'", type: 'goal', side: 'away', player: 'Alexis Saelemaekers' },
    ],
    stats: [
      { label: 'Ball possession', home: 46, away: 54, unit: '%' },
      { label: 'Expected goals (xG)', home: 0.25, away: 3.69 },
      { label: 'Total shots', home: 6, away: 35 },
      { label: 'Shots on target', home: 2, away: 10 },
      { label: 'Saves', home: 5, away: 1 },
      { label: 'Fouls', home: 10, away: 7 },
      { label: 'Yellow cards', home: 2, away: 0 },
    ],
  },
  // Saturday, June 27
  {
    id: 67, date: '2026-06-27', time: '17:00 ET', group: 'L', home: 'PAN', away: 'ENG', venue: 'MetLife Stadium', city: 'New York / New Jersey', status: 'finished', homeScore: 0, awayScore: 2,
    events: [
      { minute: "53'", type: 'yellow', side: 'home', player: 'José Fajardo' },
      { minute: "60'", type: 'yellow', side: 'away', player: 'Jarell Quansah' },
      { minute: "62'", type: 'goal', side: 'away', player: 'Jude Bellingham' },
      { minute: "67'", type: 'goal', side: 'away', player: 'Harry Kane' },
      { minute: "83'", type: 'yellow', side: 'home', player: 'Andrés Andrade' },
    ],
    stats: [
      { label: 'Ball possession', home: 33, away: 67, unit: '%' },
      { label: 'Expected goals (xG)', home: 0.66, away: 1.56 },
      { label: 'Total shots', home: 13, away: 17 },
      { label: 'Shots on target', home: 2, away: 6 },
      { label: 'Saves', home: 4, away: 2 },
  ...
  {
    id: 68, date: '2026-06-27', time: '17:00 ET', group: 'L', home: 'CRO', away: 'GHA', venue: 'Lincoln Financial Field', city: 'Philadelphia', status: 'finished', homeScore: 2, awayScore: 1,
    events: [
      { minute: "31'", type: 'goal', side: 'home', player: 'Petar Sučić' },
      { minute: "68'", type: 'yellow', side: 'home', player: 'Ivan Perišić' },
      { minute: "73'", type: 'goal', side: 'away', player: 'Derrick Luckassen' },
      { minute: "83'", type: 'goal', side: 'home', player: 'Nikola Vlašić' },
      { minute: "90+4'", type: 'yellow', side: 'away', player: 'Kojo Peprah Oppong' },
    ],
    stats: [
      { label: 'Ball possession', home: 53, away: 47, unit: '%' },
      { label: 'Expected goals (xG)', home: 0.42, away: 0.64 },
      { label: 'Total shots', home: 8, away: 6 },
      { label: 'Shots on target', home: 4, away: 1 },
      { label: 'Saves', home: 0, away: 2 },
      { label: 'Fouls', home: 9, away: 13 },
  ...
  {
    id: 69, date: '2026-06-27', time: '19:30 ET', group: 'K', home: 'COL', away: 'POR', venue: 'Hard Rock Stadium', city: 'Miami', status: 'finished', homeScore: 0, awayScore: 0,
    events: [
      { minute: "86'", type: 'yellow', side: 'home', player: 'Gustavo Puerta' },
    ],
    stats: [
      { label: 'Ball possession', home: 55, away: 45, unit: '%' },
      { label: 'Expected goals (xG)', home: 1.63, away: 0.70 },
      { label: 'Total shots', home: 24, away: 13 },
      { label: 'Shots on target', home: 6, away: 2 },
      { label: 'Saves', home: 2, away: 6 },
      { label: 'Fouls', home: 12, away: 6 },
      { label: 'Yellow cards', home: 1, away: 0 },
    ],
  },
  {
    id: 70, date: '2026-06-27', time: '19:30 ET', group: 'K', home: 'COD', away: 'UZB', venue: 'Mercedes-Benz Stadium', city: 'Atlanta', status: 'finished', homeScore: 3, awayScore: 1,
    events: [
      { minute: "10'", type: 'goal', side: 'away', player: 'Eldor Shomurodov' },
      { minute: "21'", type: 'yellow', side: 'home', player: 'Noah Sadiki' },
      { minute: "43'", type: 'yellow', side: 'away', player: 'Abdukodir Khusanov' },
      { minute: "45+4'", type: 'yellow', side: 'home', player: 'Nathanael Mbuku' },
      { minute: "47'", type: 'yellow', side: 'away', player: 'Sherzod Nasrullaev' },
      { minute: "62'", type: 'yellow', side: 'home', player: 'Samuel Moutoussamy' },
      { minute: "68'", type: 'goal', side: 'home', player: 'Yoane Wissa', note: 'penalty' },
      { minute: "78'", type: 'goal', side: 'home', player: 'Fiston Mayele' },
      { minute: "90+1'", type: 'goal', side: 'home', player: 'Yoane Wissa' },
    ],
    stats: [
      { label: 'Ball possession', home: 58, away: 42, unit: '%' },
      { label: 'Expected goals (xG)', home: 2.35, away: 0.20 },
      { label: 'Total shots', home: 19, away: 3 },
      { label: 'Shots on target', home: 4, away: 1 },
      { label: 'Saves', home: 1, away: 1 },
      { label: 'Fouls', home: 6, away: 16 },
      { label: 'Yellow cards', home: 3, away: 2 },
    ],
  },
  {
    id: 71, date: '2026-06-27', time: '21:00 CDT', group: 'J', home: 'ALG', away: 'AUT', venue: 'Arrowhead Stadium', city: 'Kansas City', status: 'finished', homeScore: 3, awayScore: 3,
    events: [
      { minute: "11'", type: 'yellow', side: 'away', player: 'Marko Arnautović' },
      { minute: "28'", type: 'goal', side: 'away', player: 'Marko Arnautović' },
      { minute: "45'", type: 'goal', side: 'home', player: 'Rafik Belghali' },
      { minute: "55'", type: 'goal', side: 'away', player: 'Marcel Sabitzer' },
      { minute: "60'", type: 'goal', side: 'home', player: 'Riyad Mahrez' },
      { minute: "90+3'", type: 'goal', side: 'home', player: 'Riyad Mahrez' },
      { minute: "90+6'", type: 'goal', side: 'away', player: 'Saša Kalajdžić' },
    ],
    stats: [
      { label: 'Ball possession', home: 65, away: 35, unit: '%' },
      { label: 'Expected goals (xG)', home: 1.62, away: 1.44 },
      { label: 'Total shots', home: 12, away: 10 },
      { label: 'Shots on target', home: 5, away: 3 },
      { label: 'Saves', home: 1, away: 2 },
      { label: 'Fouls', home: 3, away: 7 },
      { label: 'Yellow cards', home: 0, away: 1 },
    ],
  },
  {
    id: 72, date: '2026-06-27', time: '21:00 CDT', group: 'J', home: 'JOR', away: 'ARG', venue: 'AT&T Stadium', city: 'Dallas', status: 'finished', homeScore: 1, awayScore: 3,
    events: [
      { minute: "17'", type: 'yellow', side: 'home', player: 'Mohannad Abu Taha' },
      { minute: "19'", type: 'goal', side: 'away', player: 'Giovani Lo Celso' },
      { minute: "31'", type: 'goal', side: 'away', player: 'Lautaro Martínez', note: 'penalty' },
      { minute: "55'", type: 'goal', side: 'home', player: 'Mousa Al-Tamari' },
      { minute: "64'", type: 'yellow', side: 'home', player: 'Yazan Al-Arab' },
      { minute: "80'", type: 'goal', side: 'away', player: 'Lionel Messi' },
      { minute: "90+4'", type: 'yellow', side: 'home', player: 'Mohammad Abu Zraiq' },
    ],
    stats: [
      { label: 'Ball possession', home: 27, away: 73, unit: '%' },
      { label: 'Expected goals (xG)', home: 0.74, away: 2.13 },
      { label: 'Total shots', home: 5, away: 12 },
      { label: 'Shots on target', home: 1, away: 4 },
      { label: 'Saves', home: 1, away: 0 },
      { label: 'Fouls', home: 13, away: 7 },
      { label: 'Yellow cards', home: 3, away: 0 },
    ],
  },
